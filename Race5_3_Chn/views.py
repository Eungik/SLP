...
def vars_for_all_templates(self):
    return {
        'Pseudo_round': self.player.participant.vars['Race_intro_Chn']['Pseudo_Round']
    }
...
class Win(BasePage):
    def is_displayed(self):
        return self.player.Choice == 5

    def vars_for_template(self):
        return{
            'Winning_number' : Constants.Winning_number
        }

    def before_next_page(self):
         self.player.end =1
         self.participant.vars['is_winner_5_3'] = 1
         self.player.is_winner_5_3 = 1
         self.player.participant.vars['Race_intro_Chn']['Pseudo_Round'] += 1


class Lose(BasePage):
    def is_displayed(self):
        return 2 <= self.player.Choice < 5
    ...
    def before_next_page(self):
        self.player.end = 1
        self.participant.vars['is_winner_5_3'] = 0
        self.player.is_winner_5_3 = 0
        self.player.participant.vars['Race_intro_Chn']['Pseudo_Round'] += 1
