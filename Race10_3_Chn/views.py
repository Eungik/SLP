...
class Win(BasePage):
    ...
    def before_next_page(self):
         self.player.end =1
         self.participant.vars['is_winner_10_3'] = 1
         self.player.is_winner_10_3 = 1
...
class Lose(BasePage):
    def is_displayed(self):
        return 7 <= self.player.Choice < 10

    def before_next_page(self):
        self.player.end = 1
        self.participant.vars['is_winner_10_3'] = 0
        self.player.is_winner_10_3 = 0
        self.player.participant.vars['Race_intro_Chn']['Pseudo_Round'] += 1
