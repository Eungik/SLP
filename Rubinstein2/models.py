...
class Player(BasePlayer):
    ...
    Position_2=models.PositiveIntegerField()

    Answer_2=models.PositiveIntegerField(
        initial=None,
        choices=[[5,'$5'],[10,'$10'],[15,'$15'],[20,'$20'],[25,'$25'],[30,'$30'],[35,'$35'],[40,'$40'],[45,'$45'],[50,'$50']],
        widget=widgets.RadioSelectHorizontal(),
    )
    Practice1_2=models.PositiveIntegerField(
        initial=None,
        choices=[[1,'A'],[2,'B'],[3,'C'],[4,'D'],[5,'E']],
        widget=widgets.RadioSelectHorizontal(),
    )
    Practice2_2=models.CurrencyField(
        initial=None,
    )

    Practice3_2=models.PositiveIntegerField(
        choices=[[1,'A'],[2,'B'],[3,'C'],[4,'D'],[5,'E']],
        widget=widgets.RadioSelectHorizontal(),
    )
    Practice4_2=models.CurrencyField(
        initial=None,
    )
